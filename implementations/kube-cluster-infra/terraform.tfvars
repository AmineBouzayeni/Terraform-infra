...
first_machine_type    = "e2-highcpu-8" #"e2-highcpu-8" # 8 Virtual processor, 8 Go of memory to essentially run the rng, hasher, worker & redis-server components.
second_machine_type   = "e2-highcpu-4" #"e2-highcpu-4" # 4 Virtual processor, 4 Go of memory to essentially run the webui component & kibana server.
